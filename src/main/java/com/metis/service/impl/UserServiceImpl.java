...
public class UserServiceImpl implements UserService {
    ...
    /**
     * 模拟事务。 @Transactional注解并加上rollbackFor属性,传入Exception.class --
     * 即其Class的对象,包含Exception类的元数据 令事务在遇到非RuntimeException时也回滚 * 如果转账中途出了意外 Snail 和
     * Daisy 的钱都不会改变 *
    ...
    public void changeMoney() {
        ...
        // 模拟转账过程中可能遇到的意外状况
        ExceptionMsgEnum.UNEXPECTED_EXCEPTION.assertNotNull(1 / 0);
