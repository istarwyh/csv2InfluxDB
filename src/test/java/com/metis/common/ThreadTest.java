...
public class ThreadTest {
    ThreadPoolExecutor threadPool = new ThreadPoolExecutor(12,
            12, 60,
            TimeUnit.SECONDS,
            new LinkedBlockingDeque<>(30),
            new UserThreadFactory("MBinPC"),
            new UserRejectHandler());

    @Test
    void testLock() {
        var p1 = new PrintABCUsingLock(2);
